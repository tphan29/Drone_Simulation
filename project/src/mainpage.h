/*! \mainpage CSCI 3081 - Drone Delivery System - Doxygen Documentation - Madelyn Ogorek, Tony Phan, and Lucas Schober
 *
 ...
 *  - <a href="https://github.umn.edu/umn-csci-3081-f20/project-portal/blob/master/Iteration3Requirements.pdf">Iteration 3 Requirements</a>
 ...
 *  \section iteration_3 Iteration 3
 *  For our iteration 3 feature, we decided to output statistics for the simulation. We will be keeping track of 
 *  the time it takes for a package to be delivered, the amount of deliveries each drone in the system has completed,
 *  as well as the total distance each drone has traveled throughout the duration of the simulation. It is our hope that
 *  by tracking this data we can better understand how to optimize the scheduling and carrying-out of deliveries in our system.
 ...
 *  <img src="3081W iter3.png" style="width: 55vw; min-width: 330px;" />
 *
 */
