...
class DroneSimulation : public entity_project::DroneDeliverySystem {
 public:
    ...
    /**
     * This method will be used to cycle through all the
     * drones in the system and write each drone's stats variables
     * (delivery count and distance traveled) to the output file.
     */
    void OutputDroneStats();
