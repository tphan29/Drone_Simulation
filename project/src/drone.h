...
class Drone : public entity_project::Drone, public EntityObservable {
 public:
    ...
    /**
     * Increments the deliveredPackages counter.
     */
    void IncrementDeliveredPackCount() {deliveredPackagesCount_ += 1;}
    /**
    ...
    /**
     * Returns the number of packages the drone has delivered.
     * @returns number of delivered packages as a float.
     */
    int GetDeliveredPackagesCount() const { return deliveredPackagesCount_; }
    /**
     * Returns the total distance the drone has traveled.
     * @returns total distance traveled as a float.
     */
    float GetTotalDistanceTraveled() const { return totalDistanceTraveled_; }
    /**
 ...
 private:
    ...
    int deliveredPackagesCount_;
    float totalDistanceTraveled_;
